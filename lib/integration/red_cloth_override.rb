if defined?(Object::RedCloth) && !RedCloth.instance_methods.include?(:htmlesc_without_rutils)
  if RedCloth.class == Module
    # RedCloth 4
    #
    # RuTils в настоящее время не поддерживает работу с RedCloth версии 4.
    # Попробуйте заморозить RedCloth версии 3 в вашем проекте или не использовать перегрузку RuTils.
  else 
