...
# (сейчас вгружается всегда)
# unless defined?(RuTils::GilensonNew::Formatter)
  class RuTils::GilensonNew::Formatter < RuTils::GilensonNew::Typografica
  end
# end

class Object::String
  include RuTils::GilensonNew::StringFormatting
end