...
Если вы используете RuTils в одном приложении с RedCloth или BlueCloth, воспользуйтесь
дополнительными модулями RuTils::Gilenson::BlueClothExtra или RuTils::Gilenson::RedClothExtra вмеесто них.

В этих классах Gilenson будет обрабатывать типографику во всех текстах, пропускаемых через
них. 
  
  require 'gilenson/blue_cloth_extra'
  require 'gilenson/red_cloth_extra'

==  Интеграция с Rails версии 2.2.2 и выше

Используйте гем russian и RuTils как дополнение (для транслита, функций kopeek и так далее)
